...
##Demonstração do App
![Demonstração do Aplicativo](./<img width="400" height="867" alt="WhatsApp Video 2026-05-30 at 09 07 44" src="https://github.com/user-attachments/assets/7fe7f3b2-b654-4ec5-809b-5e4bdb0f9576" />)
...
* **Tratamento de Colisões (`EdgeReached`):** Uso de eventos para detectar quando o objeto atinge a borda da tela e aplicação de funções para rebater.![Uploading WhatsApp Video 2026-05-30 at 09.07.44.gif…]()
